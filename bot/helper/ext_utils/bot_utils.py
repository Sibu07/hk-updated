...
async def set_commands(client):
    if config_dict['SET_COMMANDS']:
        try:
            ...
            BotCommand(BotCommands.StatsCommand, 'Check Bot & System stats'),
            ...
            BotCommand(BotCommands.SpeedCommand, 'Check Server Up & Down Speed & Details'),
            ...
            BotCommand(BotCommands.PingCommand[0], 'Ping'),
            ]
