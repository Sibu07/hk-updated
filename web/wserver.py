    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/KCLinks">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/KCTelegram5"><i class="fab fa-github"></i></a>
        <a href="https://t.me/KCLinks"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>[KC]<a href='https://github.com/KCTelegram5'>@GitHub</a> By <a href='https://t.me/KCLinks'>Code With [KC]</a></h1>"
